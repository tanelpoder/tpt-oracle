...
--              profile directly from library cache - look up by SQL ID
--
-- Author:      Tanel Poder
...
--              3) @xbi.sql <sql_id> <sql_child_number>
--          
...
--              * deal with obsolete child cursors (multiple children possible with same sql_id/child# due to multiple parents)
...
prompt -- xbi.sql: eXplain Better v0.99 for sql_id=&xbi_sql_id child=&xbi_sql_child_number - by Tanel Poder (https://blog.tanelpoder.com)
...
-- TODO need to deal with obsolete parent cursors too
/
...
-- TODO and p.address = hextoraw('&xbi_sql_addr')
...
from (
    ...
    -- TODO AND address = HEXTORAW('&xbi_sql_addr')
